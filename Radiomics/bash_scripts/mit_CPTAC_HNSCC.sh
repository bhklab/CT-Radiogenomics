#!/usr/bin/env bash
#SBATCH --job-name=r2r_readii_mit_CPTAC-HNSCC
#SBATCH --mem=64G
#SBATCH -t 05:45:00
#SBATCH -c 16
#SBATCH --partition=himem
#SBATCH -D /cluster/home/t138199uhn/projects/med-imagetools
#SBATCH --output="/cluster/home/t138199uhn/slurm/feature_extraction/r2r_readii_mit_CPTAC-HNSCC_%j.out"
...
pixi run imgtools autopipeline \
  "/cluster/projects/radiomics/PublicDatasets/srcdata/HeadNeck/TCIA_${DATASET}/images" \
  "$PDATA/Radiogenomics/features/HeadNeck/TCIA_${DATASET}/images/mit_${DATASET}" \
