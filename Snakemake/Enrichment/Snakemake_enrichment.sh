...
snakemake --snakefile Snakefile_Enrichment.snakefile \
  ...
  --cluster "sbatch --job-name=smk_{rule} --output=/cluster/home/t138199uhn/slurm/genomics_temp/GSVA_run/{rule}.{wildcards}.out --error=/cluster/home/t138199uhn/slurm/genomics_temp/GSVA_run/{rule}.{wildcards}.err --time={resources.runtime} --mem={resources.mem_mb} --cpus-per-task=2" \
  --latency-wait 120
